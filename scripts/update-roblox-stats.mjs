...
for (const item of resolved) {
  ...
  stats[item.game.id] = {
    ...
    likeRatio: ratio,
    updatedAt: now,
    experienceUpdatedAt: details.updated || null,
    experienceCreatedAt: details.created || null,
    officialSummary: details.description || item.game.officialSummary || item.game.summary,
